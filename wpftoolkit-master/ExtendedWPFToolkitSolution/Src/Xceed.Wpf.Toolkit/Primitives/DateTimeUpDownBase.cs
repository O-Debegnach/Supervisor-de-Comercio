...
namespace Xceed.Wpf.Toolkit.Primitives
{
  public abstract class DateTimeUpDownBase<T> : UpDownBase<T>
  {
    ...
    public DateTimePart CurrentDateTimePartt
    {
      get
      {
    ...
    private void InitSelection()
    {
      ...
      {
        this.Select( (this.CurrentDateTimePartt != DateTimePart.Other) ? this.GetDateTimeInfo( this.CurrentDateTimePartt ) : this.GetDateTimeInfo( 0 ) );
      }
    }
